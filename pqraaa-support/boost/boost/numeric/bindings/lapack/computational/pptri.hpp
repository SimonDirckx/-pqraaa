...
#else
    LAPACK_SPPTRI( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPPTRI( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPPTRI( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPPTRI( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
