...
struct labrd_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorD& d, VectorE& e,
        ...
        static_assert( (bindings::is_column_major< MatrixY >::value) );
        ...
        static_assert( (bindings::is_mutable< VectorTAUQ >::value) );
        static_assert( (bindings::is_mutable< VectorTAUP >::value) );
        static_assert( (bindings::is_mutable< MatrixX >::value) );
        static_assert( (bindings::is_mutable< MatrixY >::value) );
        assert( bindings::size(d) >= bindings::size_column(a) );
        assert( bindings::size(e) >= bindings::size_column(a) );
        assert( bindings::size(taup) >= bindings::size_column(a) );
        assert( bindings::size(tauq) >= bindings::size_column(a) );
        assert( bindings::size_minor(a) == 1 ||
                bindings::stride_minor(a) == 1 );
        assert( bindings::size_minor(x) == 1 ||
                bindings::stride_minor(x) == 1 );
        assert( bindings::size_minor(y) == 1 ||
                bindings::stride_minor(y) == 1 );
        assert( bindings::stride_major(a) >= std::max< std::ptrdiff_t >(1,
                bindings::size_row(a)) );
        assert( bindings::stride_major(x) >= bindings::size_row(a) );
        assert( bindings::stride_major(y) >= bindings::size_column(a) );
...
//
template< typename Value >
struct labrd_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorD& d, VectorE& e,
        ...
        assert( bindings::stride_major(x) >= std::max< std::ptrdiff_t >(1,
                bindings::size_row(a)) );
        assert( bindings::stride_major(y) >= std::max< std::ptrdiff_t >(1,
