...
#else
    LAPACK_SPBTRS( &uplo, &n, &kd, &nrhs, ab, &ldab, b, &ldb, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPBTRS( &uplo, &n, &kd, &nrhs, ab, &ldab, b, &ldb, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPBTRS( &uplo, &n, &kd, &nrhs, ab, &ldab, b, &ldb, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPBTRS( &uplo, &n, &kd, &nrhs, ab, &ldab, b, &ldb, &info ,1 );
#endif
    return info;
}
