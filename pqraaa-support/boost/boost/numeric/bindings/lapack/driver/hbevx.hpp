...
struct hbevx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char jobz, const char range,
        ...
        assert( bindings::size(w) >= bindings::size_column(ab) );
...
//
template< typename Value >
struct hbevx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
