...
inline std::ptrdiff_t ggesx( const char jobvsl, const char jobvsr,
    ...
    LAPACK_SGGESX( &jobvsl, &jobvsr, &sort, selctg, &sense, &n, a, &lda, b,
            &ldb, &sdim, alphar, alphai, beta, vsl, &ldvsl, vsr, &ldvsr,
            rconde, rcondv, work, &lwork, iwork, &liwork, bwork, &info ,1 ,1 ,1 ,1 );
#endif
    return info;
}
...
inline std::ptrdiff_t ggesx( const char jobvsl, const char jobvsr,
    ...
    LAPACK_CGGESX( &jobvsl, &jobvsr, &sort, selctg, &sense, &n, a, &lda, b,
            &ldb, &sdim, alpha, beta, vsl, &ldvsl, vsr, &ldvsr, rconde,
            rcondv, work, &lwork, rwork, iwork, &liwork, bwork, &info ,1 ,1 ,1 ,1 );
#endif
    return info;
}
...
struct ggesx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char jobvsl, const char jobvsr,
        ...
        static_assert( (bindings::is_column_major< MatrixVSL >::value) );
        static_assert( (bindings::is_column_major< MatrixVSR >::value) );
        ...
        static_assert( (bindings::is_mutable< MatrixVSL >::value) );
        static_assert( (bindings::is_mutable< MatrixVSR >::value) );
        ...
        assert( bindings::size_minor(vsl) == 1 ||
                bindings::stride_minor(vsl) == 1 );
        assert( bindings::size_minor(vsr) == 1 ||
...
//
template< typename Value >
struct ggesx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
