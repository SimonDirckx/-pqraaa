...
#ifndef cork_matrix_valued_function_polynomial_nonlinear_hpp
#define cork_matrix_valued_function_polynomial_nonlinear_hpp
...
namespace CORK { namespace matrix_valued_function {
  ...
  class polynomial_nonlinear
  {
    ...
    public:
      polynomial_nonlinear( basis_type const& basis, functions_sequence_type const& functions_sequence, matrix_type const& matrices )
      : basis_( basis )
  ...
  template <typename Basis, typename FunctionSequence, typename CoefficientMatrices>
  decltype (auto) make_polynomial_nonlinear_lvalue( Basis const& basis, FunctionSequence const& function_sequence, CoefficientMatrices const& matrices )  {
    return nonlinear< Basis const&, FunctionSequence const&, CoefficientMatrices const& >( basis, function_sequence, matrices ) ;
  }

  template <typename Basis, typename FunctionSequence, typename CoefficientMatrices>
  decltype (auto) make_polynomial_nonlinear( Basis const& basis, FunctionSequence const& function_sequence, CoefficientMatrices const& matrices )  {
