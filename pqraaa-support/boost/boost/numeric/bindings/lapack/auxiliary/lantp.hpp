...
#else
    LAPACK_SLANTP( &norm, &uplo, &lapack_option< Diag >::value, &n, ap, work ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DLANTP( &norm, &uplo, &lapack_option< Diag >::value, &n, ap, work ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CLANTP( &norm, &uplo, &lapack_option< Diag >::value, &n, ap, work ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZLANTP( &norm, &uplo, &lapack_option< Diag >::value, &n, ap, work ,1 ,1 ,1 );
#endif
    return info;
}
