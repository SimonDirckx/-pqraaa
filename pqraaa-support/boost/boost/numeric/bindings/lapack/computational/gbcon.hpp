...
struct gbcon_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char norm, const MatrixAB& ab,
        ...
        assert( bindings::stride_major(ab) >= 2 );
...
//
template< typename Value >
struct gbcon_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
