...
#else
    LAPACK_STPCON( &norm, &lapack_option< UpLo >::value, &lapack_option<
            Diag >::value, &n, ap, &rcond, work, iwork, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CTPCON( &norm, &lapack_option< UpLo >::value, &lapack_option<
            Diag >::value, &n, ap, &rcond, work, rwork, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
struct tpcon_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct tpcon_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
tpcon( const char norm, const MatrixAP& ap, typename remove_imaginary<
        ...
        Workspace work ) {
    return tpcon_impl< typename bindings::value_type<
            MatrixAP >::type >::invoke( norm, ap, rcond, work );
}
...
//
template< typename MatrixAP >
inline typename std::enable_if<! detail::is_workspace< MatrixAP >::value,
        std::ptrdiff_t >::type
tpcon( const char norm, const MatrixAP& ap, typename remove_imaginary<
        typename bindings::value_type< MatrixAP >::type >::type& rcond ) {
    return tpcon_impl< typename bindings::value_type<
            MatrixAP >::type >::invoke( norm, ap, rcond, optimal_workspace() );
}
