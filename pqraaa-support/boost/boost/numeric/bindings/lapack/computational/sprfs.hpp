...
#else
    LAPACK_SSPRFS( &lapack_option< UpLo >::value, &n, &nrhs, ap, afp, ipiv, b,
            &ldb, x, &ldx, ferr, berr, work, iwork, &info ,1 );
#endif
    return info;
}
...
struct sprfs_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct sprfs_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
