...
struct ptrfs_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const VectorD& d, const VectorE& e,
        ...
        assert( bindings::size(df) >= bindings::size(d) );
        assert( bindings::size(e) >= bindings::size(d)-1 );
        assert( bindings::size(ef) >= bindings::size(d)-1 );
...
//
template< typename Value >
struct ptrfs_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
