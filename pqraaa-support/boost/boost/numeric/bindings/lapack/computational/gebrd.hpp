...
struct gebrd_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorD& d, VectorE& e,
        ...
        assert( bindings::size(taup) >= std::min<
                std::ptrdiff_t >(bindings::size_row(a),
                bindings::size_column(a)) );
        assert( bindings::size(tauq) >= std::min<
                std::ptrdiff_t >(bindings::size_row(a),
                bindings::size_column(a)) );
...
//
template< typename Value >
struct gebrd_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename VectorD, typename VectorE,
        typename VectorTAUQ, typename VectorTAUP >
inline typename std::enable_if<! detail::is_workspace< VectorTAUP >::value,
        std::ptrdiff_t >::type
gebrd( MatrixA& a, VectorD& d, VectorE& e, VectorTAUQ& tauq,
        VectorTAUP& taup ) {
    return gebrd_impl< typename bindings::value_type<
