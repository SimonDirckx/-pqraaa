...
//
// The LAPACK-backend for sytri is the netlib-compatible backend.
//
...
struct sytri_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct sytri_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
