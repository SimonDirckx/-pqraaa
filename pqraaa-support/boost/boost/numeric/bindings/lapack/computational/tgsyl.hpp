...
struct tgsyl_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const fortran_int_t ijob,
        ...
        static_assert( (bindings::is_column_major< MatrixD >::value) );
        static_assert( (bindings::is_column_major< MatrixE >::value) );
        static_assert( (bindings::is_column_major< MatrixF >::value) );
        ...
        static_assert( (bindings::is_mutable< MatrixF >::value) );
        ...
        assert( bindings::size_minor(d) == 1 ||
                bindings::stride_minor(d) == 1 );
        assert( bindings::size_minor(e) == 1 ||
                bindings::stride_minor(e) == 1 );
        assert( bindings::size_minor(f) == 1 ||
...
//
template< typename Value >
struct tgsyl_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename MatrixB, typename MatrixC,
        typename MatrixD, typename MatrixE, typename MatrixF >
inline typename std::enable_if<! detail::is_workspace< MatrixF >::value,
        std::ptrdiff_t >::type
tgsyl( const fortran_int_t ijob, const MatrixA& a, const MatrixB& b,
        MatrixC& c, const MatrixD& d, const MatrixE& e, MatrixF& f,
        typename remove_imaginary< typename bindings::value_type<
