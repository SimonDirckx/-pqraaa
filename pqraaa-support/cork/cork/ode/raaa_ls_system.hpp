...
#ifndef cork_matrix_ode_raaa_ls_system_hpp
#define cork_matrix_ode_raaa_ls_system_hpp
...
namespace CORK { namespace ode {
  ...
  auto raaa_ls_system( NEP const& problem, Domain const& domain, Options const& options ) {
    ...
    auto PEP_aaa = CORK::matrix_valued_function::sv_raaa_ls( nep_time, nep_aaa, domain, norm_est, options ) ;
