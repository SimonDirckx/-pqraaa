...
namespace glas2 {
  ...
  class scalar_matrix_expression {
    ...
    public:
      ...
      value_type operator[] ( size_type i) const { return Op()( scalar_, matrix_[i] ) ; }
  ...
  template <typename S, typename M, typename Op>
  struct concept< scalar_matrix_expression<S,M,Op>, typename std::enable_if< is<DenseMatrix,M>::value >::type >
  : DenseMatrix
  {} ;
