...
struct gesvd_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char jobu, const char jobvt,
        ...
        static_assert( (bindings::is_column_major< MatrixU >::value) );
        static_assert( (bindings::is_column_major< MatrixVT >::value) );
        ...
        static_assert( (bindings::is_mutable< MatrixU >::value) );
        static_assert( (bindings::is_mutable< MatrixVT >::value) );
        assert( bindings::size(s) >= std::min<
...
//
template< typename Value >
struct gesvd_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename VectorS, typename MatrixU,
        typename MatrixVT >
inline typename std::enable_if< !detail::is_workspace< MatrixVT >::value,
        std::ptrdiff_t >::type
gesvd( const char jobu, const char jobvt, MatrixA& a, VectorS& s,
