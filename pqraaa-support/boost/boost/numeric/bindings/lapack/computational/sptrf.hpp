...
#else
    LAPACK_SSPTRF( &lapack_option< UpLo >::value, &n, ap, ipiv, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DSPTRF( &lapack_option< UpLo >::value, &n, ap, ipiv, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CSPTRF( &lapack_option< UpLo >::value, &n, ap, ipiv, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZSPTRF( &lapack_option< UpLo >::value, &n, ap, ipiv, &info ,1 );
#endif
    return info;
}
