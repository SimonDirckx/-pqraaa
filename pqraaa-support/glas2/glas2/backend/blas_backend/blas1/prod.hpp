...
#ifndef glas2_backend_blas_backend_vector_algorithm_prod_hpp
#define glas2_backend_blas_backend_vector_algorithm_prod_hpp
...
namespace glas2 {
  ...
  typename std::enable_if< is<DenseVector,X>::value
                         ...
                         >::type prod( blas_backend, X const& x ) {
