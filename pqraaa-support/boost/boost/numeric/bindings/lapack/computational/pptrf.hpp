...
#else
    LAPACK_SPPTRF( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPPTRF( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPPTRF( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPPTRF( &lapack_option< UpLo >::value, &n, ap, &info ,1 );
#endif
    return info;
}
