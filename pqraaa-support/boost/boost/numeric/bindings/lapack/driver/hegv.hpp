...
#else
    LAPACK_CHEGV( &itype, &jobz, &lapack_option< UpLo >::value, &n, a, &lda,
            b, &ldb, w, work, &lwork, rwork, &info ,1 ,1 );
#endif
    return info;
}
...
struct hegv_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct hegv_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
