...
struct ggrqf_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorTAUA& taua, MatrixB& b,
        ...
        static_assert( (bindings::is_mutable< VectorTAUA >::value) );
        static_assert( (bindings::is_mutable< MatrixB >::value) );
        static_assert( (bindings::is_mutable< VectorTAUB >::value) );
        assert( bindings::size(taua) >= std::min<
                std::ptrdiff_t >(bindings::size_row(a),
                bindings::size_column(a)) );
        assert( bindings::size(taub) >= std::min<
...
//
template< typename Value >
struct ggrqf_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename VectorTAUA, typename MatrixB,
        typename VectorTAUB >
inline typename std::enable_if<! detail::is_workspace< VectorTAUB >::value,
        std::ptrdiff_t >::type
ggrqf( MatrixA& a, VectorTAUA& taua, MatrixB& b, VectorTAUB& taub ) {
    return ggrqf_impl< typename bindings::value_type<
