...
#include <glas3/array/array_network/algorithm/ipermute.hpp>
...
int main() {
    ...
    std::cout << "auto t1_p = glas3::ipermute( t1, {1, 2, 0} ) ;" << '\n' << '\n' ;
    auto t1_p = glas3::ipermute( t1, {1, 2, 0} ) ;
    glas3::randomize( t1, g ) ;
    auto t1_full_p = glas3::ipermute( glas3::full( t1 ), {1, 2, 0} );
    ...
    std::cout << "ipermute operation (shallow copy)" << '\n' ;
    std::cout << "auto t2_p = glas3::permute( t2, {1, 2, 0} ) ;" << '\n' ;
    auto t2_p = glas3::ipermute( t2, {2, 0, 1} ) ;
    glas3::randomize( t2, g ) ;
    auto t2_full_p = glas3::ipermute( glas3::full( t2 ), {2, 0, 1} );
