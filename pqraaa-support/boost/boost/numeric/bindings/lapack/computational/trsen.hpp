...
struct trsen_impl {
    ...
    static std::ptrdiff_t invoke( const char job, const char compq,
        ...
        assert( bindings::size(select) >= bindings::size_column(t) );
        assert( bindings::size(w) >= bindings::size_column(t) );
...
trsen( const char job, const char compq, const VectorSELECT& select,
        ...
        typename bindings::value_type< VectorSELECT >::type >::type& s,
        typename remove_imaginary< typename bindings::value_type<
