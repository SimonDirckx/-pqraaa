...
struct gglse_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, MatrixB& b, VectorC& c,
        ...
        assert( bindings::size(c) >= bindings::size_row(a) );
        assert( bindings::size(d) >= bindings::size_row(b) );
...
//
template< typename Value >
struct gglse_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename MatrixB, typename VectorC,
        typename VectorD, typename VectorX >
inline typename std::enable_if<! detail::is_workspace< VectorX >::value,
        std::ptrdiff_t >::type
gglse( MatrixA& a, MatrixB& b, VectorC& c, VectorD& d, VectorX& x ) {
    return gglse_impl< typename bindings::value_type<
