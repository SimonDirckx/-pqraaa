...
#else
    LAPACK_SPOTRF( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 ,1 ,1 ,1 ,1 ,1 ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPOTRF( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPOTRF( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPOTRF( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
