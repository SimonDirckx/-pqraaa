...
struct ppsvx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char fact, MatrixAP& ap,
        ...
        static_assert( (bindings::is_mutable< VectorAFP >::value) );
...
//
template< typename Value >
struct ppsvx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
