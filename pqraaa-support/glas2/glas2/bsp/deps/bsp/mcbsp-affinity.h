...
/**
 * Prevents the use of a given number of
 * threads at the same core.
 *
 * @param unused_threads_per_core The number
 * of threads on each core that cannot be used
 * by BSP threads.
 */
...
/**
 * @return The number of unused threads
 *         per core.
