...
struct gbsvx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char fact, MatrixAB& ab,
        ...
        static_assert( (bindings::is_mutable< MatrixAFB >::value) );
        ...
        assert( bindings::bandwidth_lower_op(ab, trans()) >= 0 );
        ...
        assert( bindings::size_column_op(ab, trans()) >= 0 );
        assert( bindings::size_minor(ab) == 1 ||
                bindings::stride_minor(ab) == 1 );
        assert( bindings::size_minor(afb) == 1 ||
        ...
        assert( bindings::stride_major(afb) >=
        ...
        assert( bindings::stride_major(x) >= std::max< std::ptrdiff_t >(1,
                bindings::size_column_op(ab, trans())) );
        assert( (bindings::bandwidth_upper_op(ab, trans())-
...
//
template< typename Value >
struct gbsvx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
