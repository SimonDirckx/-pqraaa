...
struct gels_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( MatrixA& a, MatrixB& b, detail::workspace1<
        ...
        assert( bindings::size_row_op(a, trans()) >= 0 );
...
//
template< typename Value >
struct gels_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
//
template< typename MatrixA, typename MatrixB >
inline typename std::enable_if< !detail::is_workspace< MatrixB >::value,
        std::ptrdiff_t >::type
