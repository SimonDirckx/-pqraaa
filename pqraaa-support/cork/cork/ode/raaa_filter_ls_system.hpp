...
#ifndef cork_matrix_ode_raaa_filter_ls_system_hpp
#define cork_matrix_ode_raaa_filter_ls_system_hpp

#include <cork/linearization/union_of_bases.hpp>
#include <cork/linearization/barycentric_rational_real_strong.hpp>
#include <cork/linearization/partial_fractions_real.hpp>
...
namespace CORK { namespace ode {
  ...
  auto raaa_filter_ls_system( NEP const& problem, Domain const& domain, Options const& options ) {
    ...
    auto PEP_aaa = CORK::matrix_valued_function::sv_raaa_filtered_ls( nep_time, nep_aaa, domain, norm_est, options ) ;
