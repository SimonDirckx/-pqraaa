...
#else
    LAPACK_SPBSTF( &lapack_option< UpLo >::value, &n, &kd, ab, &ldab, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPBSTF( &lapack_option< UpLo >::value, &n, &kd, ab, &ldab, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPBSTF( &lapack_option< UpLo >::value, &n, &kd, ab, &ldab, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPBSTF( &lapack_option< UpLo >::value, &n, &kd, ab, &ldab, &info ,1 );
#endif
    return info;
}
