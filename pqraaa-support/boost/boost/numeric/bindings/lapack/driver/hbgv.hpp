...
#else
    LAPACK_CHBGV( &jobz, &lapack_option< UpLo >::value, &n, &ka, &kb, ab,
            &ldab, bb, &ldbb, w, z, &ldz, work, rwork, &info ,1 ,1 );
#endif
    return info;
}
...
struct hbgv_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct hbgv_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
