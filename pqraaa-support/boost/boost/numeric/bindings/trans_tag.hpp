...
template<>
struct trans_tag_impl< tag::column_major, tag::column_major, std::false_type > {
    typedef tag::no_transpose type;
};

template<>
struct trans_tag_impl< tag::column_major, tag::row_major, std::false_type > {
...
template<>
struct trans_tag_impl< tag::row_major, tag::row_major, std::false_type  > {
    typedef tag::no_transpose type;
};

template<>
struct trans_tag_impl< tag::row_major, tag::column_major, std::false_type > {
    typedef tag::transpose type;
};
