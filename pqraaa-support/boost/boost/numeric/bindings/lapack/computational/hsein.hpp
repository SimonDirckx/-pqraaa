...
struct hsein_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const Side side, const char eigsrc,
        ...
        static_assert( (bindings::is_column_major< MatrixH >::value) );
        ...
        static_assert( (bindings::is_mutable< VectorSELECT >::value) );
        ...
        static_assert( (bindings::is_mutable< VectorIFAILL >::value) );
        static_assert( (bindings::is_mutable< VectorIFAILR >::value) );
        assert( bindings::size(select) >= bindings::size_column(h) );
        assert( bindings::size(wi) >= bindings::size_column(h) );
        assert( bindings::size(work.select(real_type())) >=
                min_size_work( bindings::size_column(h), ?2 ));
        assert( bindings::size(wr) >= bindings::size_column(h) );
        assert( bindings::size_column(h) >= 0 );
        assert( bindings::size_minor(h) == 1 ||
        ...
        assert( bindings::stride_major(h) >= std::max< std::ptrdiff_t >(1,
...
//
template< typename Value >
struct hsein_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const Side side, const char eigsrc,
        ...
        static_assert( (bindings::is_mutable< VectorIFAILR >::value) );
        assert( bindings::size(select) >= bindings::size_column(h) );
        assert( bindings::size(w) >= bindings::size_column(h) );
        assert( bindings::size(work.select(real_type())) >=
...
template< typename Side, typename VectorSELECT, typename MatrixH,
        typename VectorWR, typename VectorWI, typename MatrixVL,
        typename MatrixVR, typename VectorIFAILL, typename VectorIFAILR >
inline typename std::enable_if<! detail::is_workspace< VectorIFAILR >::value,
        std::ptrdiff_t >::type
hsein( const Side side, const char eigsrc, const char initv,
        VectorSELECT& select, const MatrixH& h, VectorWR& wr,
        const VectorWI& wi, MatrixVL& vl, MatrixVR& vr,
