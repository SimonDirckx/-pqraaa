...
#else
    LAPACK_SLANSP( &norm, &lapack_option< UpLo >::value, &n, ap, work ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DLANSP( &norm, &lapack_option< UpLo >::value, &n, ap, work ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CLANSP( &norm, &lapack_option< UpLo >::value, &n, ap, work ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZLANSP( &norm, &lapack_option< UpLo >::value, &n, ap, work ,1 ,1 );
#endif
    return info;
}
