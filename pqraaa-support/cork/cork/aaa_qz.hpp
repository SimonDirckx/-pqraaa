...
#ifndef cork_aaa_qz_hpp
#define cork_aaa_qz_hpp
...
namespace CORK {
  ...
  */
  ...
  decltype (auto) aaa_qz( NEP const& problem, Domain const& aaa_domain, EigenvalueSelector const& eig_selector, Options const& options ) {
    ...
    auto [PEP, aaa_info] = CORK::matrix_valued_function::sv_aaa( nep_aaa, aaa_domain, norm_est, options ) ;
