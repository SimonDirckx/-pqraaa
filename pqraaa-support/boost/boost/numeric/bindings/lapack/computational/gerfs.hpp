...
struct gerfs_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const MatrixA& a, const MatrixAF& af,
        ...
        assert( bindings::size(ipiv) >= bindings::size_column_op(a,
                trans()) );
...
//
template< typename Value >
struct gerfs_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
