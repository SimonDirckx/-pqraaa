...
struct ptsvx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char fact, const VectorD& d,
        ...
        static_assert( (bindings::is_mutable< VectorEF >::value) );
...
//
template< typename Value >
struct ptsvx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
