...
#else
    LAPACK_SPOTRI( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 ,1 ,1 ,1 ,1 ,1 ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DPOTRI( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPOTRI( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZPOTRI( &lapack_option< UpLo >::value, &n, a, &lda, &info ,1 );
#endif
    return info;
}
