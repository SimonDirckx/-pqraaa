...
#else
    LAPACK_SPORFS( &lapack_option< UpLo >::value, &n, &nrhs, a, &lda, af,
            &ldaf, b, &ldb, x, &ldx, ferr, berr, work, iwork, &info ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CPORFS( &lapack_option< UpLo >::value, &n, &nrhs, a, &lda, af,
            &ldaf, b, &ldb, x, &ldx, ferr, berr, work, rwork, &info ,1 );
#endif
    return info;
}
...
struct porfs_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct porfs_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
