...
struct spcon_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct spcon_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
