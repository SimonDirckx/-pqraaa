...
struct ptcon_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct ptcon_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
//
template< typename VectorD, typename VectorE >
inline typename std::enable_if<! detail::is_workspace< VectorE >::value,
        std::ptrdiff_t >::type
ptcon( const VectorD& d, const VectorE& e,
        const typename remove_imaginary< typename bindings::value_type<
        VectorE >::type >::type anorm, typename remove_imaginary<
