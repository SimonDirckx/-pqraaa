...
#else
    LAPACK_SHGEQZ( &job, &compq, &compz, &n, &ilo, &ihi, h, &ldh, t, &ldt,
            alphar, alphai, beta, q, &ldq, z, &ldz, work, &lwork, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CHGEQZ( &job, &compq, &compz, &n, &ilo, &ihi, h, &ldh, t, &ldt,
            alpha, beta, q, &ldq, z, &ldz, work, &lwork, rwork, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
struct hgeqz_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char job, const char compq,
        ...
        static_assert( (bindings::is_mutable< MatrixH >::value) );
        ...
        assert( bindings::size(alphar) >= bindings::size_column(h) );
        assert( bindings::size(beta) >= bindings::size_column(h) );
...
//
template< typename Value >
struct hgeqz_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char job, const char compq,
        ...
        static_assert( (bindings::is_mutable< MatrixQ >::value) );
        static_assert( (bindings::is_mutable< MatrixZ >::value) );
        assert( bindings::size(alpha) >= bindings::size_column(h) );
        assert( bindings::size(beta) >= bindings::size_column(h) );
        assert( bindings::size(work.select(real_type())) >=
