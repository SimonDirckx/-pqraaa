...
struct geqrf_impl< Value, typename std::enable_if< ::boost::numeric::bindings::is_real< Value >::value >::type > {

    typedef Value value_type;
    typedef typename ::boost::numeric::bindings::remove_imaginary< Value >::type real_type;
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorTAU& tau,
            ::boost::numeric::bindings::lapack::detail::workspace1< WORK > work ) {
        ...
        assert( bindings::size(tau) >= std::min<
    ...
    static std::ptrdiff_t invoke( MatrixA& a, VectorTAU& tau,
            ::boost::numeric::bindings::lapack::minimal_workspace work ) {
        namespace bindings = ::boost::numeric::bindings;
...
//
template< typename Value >
struct geqrf_impl< Value, typename std::enable_if< ::boost::numeric::bindings::is_complex< Value >::value >::type > {
...
geqrf( MatrixA& a, VectorTAU& tau ) {
    return geqrf_impl< typename bindings::value_type<
            MatrixA >::type >::invoke( a, tau, ::boost::numeric::bindings::lapack::optimal_workspace() );
}
...
inline typename std::enable_if< detail::is_workspace< Workspace >::value,
        std::ptrdiff_t >::type
geqrf( MatrixA& a, const VectorTAU& tau, Workspace work ) {
    return geqrf_impl< typename bindings::value_type<
            MatrixA >::type >::invoke( a, tau, work );
}
...
inline typename std::enable_if< !detail::is_workspace< VectorTAU >::value,
        std::ptrdiff_t >::type
geqrf( MatrixA& a, const VectorTAU& tau ) {
    return geqrf_impl< typename bindings::value_type<
            MatrixA >::type >::invoke( a, tau, ::boost::numeric::bindings::lapack::optimal_workspace() );
}
...
inline typename std::enable_if< detail::is_workspace< Workspace >::value,
        std::ptrdiff_t >::type
geqrf( const MatrixA& a, const VectorTAU& tau, Workspace work ) {
    return geqrf_impl< typename bindings::value_type<
            MatrixA >::type >::invoke( a, tau, work );
}
...
inline typename std::enable_if< !detail::is_workspace< VectorTAU >::value,
        std::ptrdiff_t >::type
geqrf( const MatrixA& a, const VectorTAU& tau ) {
    return geqrf_impl< typename bindings::value_type<
            MatrixA >::type >::invoke( a, tau, ::boost::numeric::bindings::lapack::optimal_workspace() );
}
