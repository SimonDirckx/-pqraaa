...
struct gbrfs_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const MatrixAB& ab, const MatrixAFB& afb,
        ...
        assert( bindings::size(ipiv) >= bindings::size_column(ab) );
        ...
        assert( bindings::stride_major(ab) >=
                ...
                1 );
        assert( bindings::stride_major(afb) >= 2 );
...
//
template< typename Value >
struct gbrfs_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
