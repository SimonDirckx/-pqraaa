...
#ifdef BOOST_NUMERIC_BINDINGS_USE_MKL
    #define MKL_Complex8 std::complex<float>
    #define MKL_Complex16 std::complex<double>
    #include <mkl_lapack.h>
#elif defined(BOOST_NUMERIC_BINDINGS_USE_SYSTEM_LAPACK_H)
    #define lapack_complex_float std::complex<float>
    #define lapack_complex_double std::complex<double>
    #define lapack_int fortran_int_t
    #define lapack_logical fortran_bool_t 
    #include <lapack.h>
#else
...
#endif // BOOST_NUMERIC_BINDINGS_USE_MKL
