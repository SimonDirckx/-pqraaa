...
#ifndef cork_matrix_iterator_partial_fractions_real_hpp
#define cork_matrix_iterator_partial_fractions_real_hpp
...
namespace CORK { namespace matrix_iterator {
  ...
  class matrix_iterator< basis::partial_fractions_real< Poles, Weights, I > >
  {
    public:
      typedef basis::partial_fractions_real< Poles, Weights, I >      basis_type ;
