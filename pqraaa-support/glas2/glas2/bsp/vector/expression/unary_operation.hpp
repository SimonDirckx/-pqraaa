...
#ifndef glas2_bsp_vector_expression_unary_operation_hpp
#define glas2_bsp_vector_expression_unary_operation_hpp
...
namespace glas2 {
  ...
  class unary_operation< V, Op
                        , typename std::enable_if< is<bsp::BSPVector,V>::value >::type
                        >
  {
    public:
  ...
  struct concept< glas2::unary_operation<V,F>, typename std::enable_if< is<bsp::BSPVector,V>::value >::type >
  : bsp::BSPVector
  {} ;
