...
struct lalsd_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char uplo,
        ...
        assert( bindings::size_column(b) >= 1 );
...
//
template< typename Value >
struct lalsd_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
