...
#else
    LAPACK_SLARFT( &direct, &storev, &n, &k, v, &ldv, tau, t, &ldt ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_DLARFT( &direct, &storev, &n, &k, v, &ldv, tau, t, &ldt ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_CLARFT( &direct, &storev, &n, &k, v, &ldv, tau, t, &ldt ,1 ,1 );
#endif
    return info;
}
...
#else
    LAPACK_ZLARFT( &direct, &storev, &n, &k, v, &ldv, tau, t, &ldt ,1 ,1 );
#endif
    return info;
}
