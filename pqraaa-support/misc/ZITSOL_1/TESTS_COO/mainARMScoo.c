...
#define TOL_DD 0.1            /* diagonal dominance tolerance for ind-*/
                              /*-ependent sets                        */
/*-------------------- protos */
...
/*-------------------- set default parameters for arms */
...
/* sprintf( io.outfile, "OUT/%s_ARMS.out", io.HBnameF );*/
    if (io.perm_type){
...
/*-------------------- LOOP THROUGH PARAMETERS */
	...
	goto NEXT_PARA;
      ...
      io.tm_p = tm2 - tm1;
      io.fillfact = (double)znnz_arms( ArmsSt, ipar[0], flog)/(double)(nnz + 1); 
