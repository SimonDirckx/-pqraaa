...
struct gges_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct gges_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
...
template< typename MatrixA, typename MatrixB, typename VectorALPHAR,
        typename VectorALPHAI, typename VectorBETA, typename MatrixVSL,
        typename MatrixVSR >
inline typename std::enable_if< !detail::is_workspace< MatrixVSR >::value,
        std::ptrdiff_t >::type
gges( const char jobvsl, const char jobvsr, const char sort,
        external_fp selctg, MatrixA& a, MatrixB& b, fortran_int_t& sdim,
        VectorALPHAR& alphar, VectorALPHAI& alphai, VectorBETA& beta,
