...
struct gtsvx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const char fact, const VectorDL& dl,
        ...
        static_assert( (bindings::is_mutable< VectorDLF >::value) );
        static_assert( (bindings::is_mutable< VectorDF >::value) );
        static_assert( (bindings::is_mutable< VectorDUF >::value) );
        static_assert( (bindings::is_mutable< VectorDU2 >::value) );
        ...
        assert( bindings::size(d) >= bindings::size_column_op(d,
                trans()) );
        assert( bindings::size(dl) >= bindings::size_column_op(d,
                trans())-1 );
        assert( bindings::size(du) >= bindings::size_column_op(d,
                trans())-1 );
        ...
        assert( bindings::size_column_op(d, trans()) >= 0 );
...
//
template< typename Value >
struct gtsvx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
