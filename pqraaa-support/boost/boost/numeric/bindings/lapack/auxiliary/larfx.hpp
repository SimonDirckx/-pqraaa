...
struct larfx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const Side side, const VectorV& v,
        ...
        assert( bindings::stride_major(c) >= (ERROR) );
...
//
template< typename Value >
struct larfx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
