...
#ifndef glas2_backend_default_backend_vector_algorithm_sum_hpp
#define glas2_backend_default_backend_vector_algorithm_sum_hpp
...
namespace glas2 {
  ...
  typename std::enable_if< is<DenseVector,X>::value
                         ...
                         >::type sum( default_backend, X const& x ) {
