...
struct gehrd_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
    ...
    static std::ptrdiff_t invoke( const fortran_int_t ilo,
        ...
        assert( bindings::size(tau) >= bindings::size_column(a)-1 );
...
//
template< typename Value >
struct gehrd_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
