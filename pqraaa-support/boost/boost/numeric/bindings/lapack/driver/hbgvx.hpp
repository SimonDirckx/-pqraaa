...
inline std::ptrdiff_t hbgvx( const char jobz, const char range,
    ...
    LAPACK_SSBGVX( &jobz, &range, &lapack_option< UpLo >::value, &n, &ka, &kb,
            ab, &ldab, bb, &ldbb, q, &ldq, &vl, &vu, &il, &iu, &abstol, &m, w,
            z, &ldz, work, iwork, ifail, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
inline std::ptrdiff_t hbgvx( const char jobz, const char range,
    ...
    LAPACK_CHBGVX( &jobz, &range, &lapack_option< UpLo >::value, &n, &ka, &kb,
            ab, &ldab, bb, &ldbb, q, &ldq, &vl, &vu, &il, &iu, &abstol, &m, w,
            z, &ldz, work, rwork, iwork, ifail, &info ,1 ,1 ,1 );
#endif
    return info;
}
...
struct hbgvx_impl< Value, typename std::enable_if< is_real< Value >::value >::type > {
...
//
template< typename Value >
struct hbgvx_impl< Value, typename std::enable_if< is_complex< Value >::value >::type > {
