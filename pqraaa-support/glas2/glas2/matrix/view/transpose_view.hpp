#ifndef glas2_matrix_view_transpose_view_hpp
#define glas2_matrix_view_transpose_view_hpp
...
namespace glas2 {
  ...
  template <typename O>
  struct transpose_view_orientation
  {} ;

  template <>
  struct transpose_view_orientation< row_major >
  {
    typedef column_major type ;
  } ;

  template <>
  struct transpose_view_orientation< column_major >
  {
  ...
  class transpose_view {
    public:
      ...
      typedef typename transpose_view_orientation< typename M::orientation >::type orientation ;
  ...
  template <typename M>
  struct glas_concept< transpose_view<M> >
  : glas_concept<M>
  {} ;
