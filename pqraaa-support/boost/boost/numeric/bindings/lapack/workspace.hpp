...
template< typename T >
struct is_workspace: std::false_type {};

template<>
struct is_workspace< minimal_workspace >: std::true_type {};

template<>
struct is_workspace< optimal_workspace >: std::true_type {};

template< typename T >
struct is_workspace< workspace1<T> >: std::true_type {};

template< typename T1, typename T2 >
struct is_workspace< workspace2<T1,T2> >: std::true_type {};

template< typename T1, typename T2, typename T3 >
struct is_workspace< workspace3<T1,T2,T3> >: std::true_type {};

template< typename T1, typename T2, typename T3, typename T4 >
struct is_workspace< workspace4<T1,T2,T3,T4> >: std::true_type {};
